...
<%
    ...
    final String $MSG_ADD_SUCCESS ="添加成功";
    final String $MSG_EDIT_SUCCESS ="修改成功";
    final String $MSG_DEL_SUCCESS ="删除成功";
    ...
    pageContext.setAttribute("MSG_ADD_SUCCESS", $MSG_ADD_SUCCESS);
    pageContext.setAttribute("MSG_EDIT_SUCCESS", $MSG_EDIT_SUCCESS);
    pageContext.setAttribute("MSG_DEL_SUCCESS", $MSG_DEL_SUCCESS);
/** mvc方法 **/
%>
<%!
