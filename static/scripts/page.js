var MyWin = new Win();
var imgfile = "http://sl.21gwy.com/images/page/";//设置图片路径，相对或绝对都行
...
function Win()
{
 this.Create = function(mask,title, wbody, w, h, l, t)
 {
  ...
  t = t || hh;
    ...
    ndiv.style.cssText = "width:"+ sw +"px;height:"+ sh +"px;left:0px;top:0px;position:absolute;overflow:hidden;background:#fff;filter:alpha(opacity=80); opacity:0.2;-moz-opacity:0.2;";
