...
<div class="up72_edit">
  <form:form id="admin_${component}_${classNameFirstLower}_edit_form" method="post" action="<@jspEl "ctx"/>/admin/${component}/${classNameFirstLower}/" modelAttribute="${classNameFirstLower}" >
