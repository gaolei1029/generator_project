		...
		<form name="${component}_${classNameFirstLower}_search_form" id="${component}_${classNameFirstLower}_search_form" method="get">
			<#list table.columns as column>
				<#if !column.htmlHidden>
					...
					<input type="text" id="${column.columnNameLower}" name="${column.columnNameLower}" class="s1 gray" value="<@jspEl 'query.${column.columnNameLower}'/>"><#if ((column_index+1) != (table.columns)?size)>　</#if>
				</#if>
			</#list>
